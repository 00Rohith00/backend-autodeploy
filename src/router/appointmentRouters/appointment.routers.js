...
//get routers
appointmentRouters.get('/list-of-health-centers', middleware.listOfHealthCenterApi, controller.listOfHealthCenterApi)
appointmentRouters.get('/list-of-hospital-doctors', middleware.listOfHospitalDoctorsApi, controller.listOfHospitalDoctorsApi)
appointmentRouters.get('/list-of-scan-types', middleware.listOfScanTypesApi, controller.listOfScanTypesApi)
